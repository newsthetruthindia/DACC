const PLANS = {
  REGULAR:  { label: 'Standard Member', price: 100 },
  SILVER:   { label: 'Standard Member', price: 100 },
  GOLD:     { label: 'Standard Member', price: 100 },
  PLATINUM: { label: 'Standard Member', price: 100 },
};
